...
def kfservingPipeline(
    action='apply',
    model_name='yolov7',
    model_uri='https://github.com/WongKinYiu/yolov7/releases/download/v0.1/yolov7.pt',
    namespace='kubeflow-user-example-com',
    runtime_version='v0.0.2',
):
    ...
    spec:
      predictor:
        ...
        maxReplicas: 1
        containers:
        - image: footprintai/yolov7-objectdetector:{3}
          # see repo: https://github.com/FootprintAI/yolov7
          name: kfserving-container
          args: ["kserve-detect.py"]
          resources:
            limits:
              memory: "4Gi"
              cpu: "1"
